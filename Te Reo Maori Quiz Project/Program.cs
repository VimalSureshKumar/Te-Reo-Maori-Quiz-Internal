...
{
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("You know are answering Basic Level Questions. ");
            Console.ReadLine();
            Console.WriteLine("Select either A, B, C, D in Keyboard, Press Enter to confirm. ");
            Console.ReadLine();
            ...
            Console.WriteLine("You now are answering Medium Level Question. ");
            Console.ReadLine();
